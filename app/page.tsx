    ...
    <main className="min-h-screen bg-[#0d1117] text-[#c9d1d9]">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        <p className="text-lg text-[#8b949e] mb-8 max-w-xl mx-auto">
          Connect to Jira, pull completed tickets from any project or sprint, and let AI craft polished, user-friendly changelog entries in seconds.
        </p>
        <a
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
          {[
            { icon: "🔗", title: "Jira Integration", desc: "OAuth connect to any Jira Cloud workspace in one click." },
            { icon: "🤖", title: "AI Formatting", desc: "Tickets transformed into clear, human-readable changelog entries." },
            { icon: "📋", title: "Custom Templates", desc: "Choose tone, format, and audience for every release." }
          ].map((f) => (
        ...
        <div className="bg-[#161b22] border border-[#58a6ff] rounded-2xl p-8 text-center shadow-lg">
          ...
          <ul className="text-left space-y-3 mb-8">
            {[
              ...
              "Export to Markdown, HTML, Notion",
          ...
          {[
            {
              ...
              a: "We support Jira Cloud (Free, Standard, Premium). Jira Data Center support is on the roadmap."
            },
            {
              q: "How does the AI generate changelogs?",
              a: "We read ticket summaries, descriptions, and labels, then use an LLM to rewrite them in plain language grouped by feature area or type."
            },
            {
              q: "Can I customize the output format?",
              a: "Yes. Choose from built-in templates (developer, end-user, executive) or write your own prompt template to match your brand voice."
            }
          ].map((item) => (
      ...
      <footer className="text-center pb-10 text-xs text-[#8b949e]">
        © {new Date().getFullYear()} Changelog Jira Auto Generator. All rights reserved.
      </footer>
    </main>
  );
}
